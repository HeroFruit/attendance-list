    ...
    return (
      <SafeAreaView style={commonStyles.wrapper}>
        <View style={[commonStyles.container, commonStyles.centerContent]}>
          <Text style={commonStyles.text}>Loading reports...</Text>
        </View>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={commonStyles.wrapper}>
      ...
      <ScrollView style={commonStyles.content}>
        <View style={commonStyles.section}>
          ...
          <View style={commonStyles.card}>
            ...
            <View style={commonStyles.row}>
              <View style={commonStyles.centerContent}>
                ...
                <Text style={commonStyles.textSecondary}>Attendance Rate</Text>
              </View>
              <View style={commonStyles.centerContent}>
          ...
          {/* Student Statistics */}
          <View style={commonStyles.card}>
            <Text style={commonStyles.subtitle}>Student Statistics</Text>
            {studentStats.length === 0 ? (
              <View style={commonStyles.centerContent}>
                <Icon name="bar-chart-outline" size={48} style={{ color: colors.textSecondary, marginBottom: 16 }} />
                <Text style={commonStyles.textSecondary}>No attendance data yet</Text>
              </View>
            ) : (
              studentStats
          ...
          {attendanceHistory.length === 0 && (
            <View style={[commonStyles.card, commonStyles.centerContent]}>
              ...
              <Text style={commonStyles.text}>No attendance records yet</Text>
              <Text style={commonStyles.textSecondary}>Start taking attendance to see reports</Text>
